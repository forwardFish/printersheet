...
任务要求：
核对/完善上传 PDF/Word/图片/文档主流程：选择、类型/大小校验、文件卡片、删除/重新选择、解析状态、生成参数传入、后端临时解析/清理、降级提示、接口占位。输出 task-05-report.md、project-state.md。

结束条件：
1. 写出 docs/auto-execute/task-05-report.md。
