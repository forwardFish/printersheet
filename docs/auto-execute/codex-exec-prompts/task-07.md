...
当前任务编号：Task 07
当前任务标题：试卷预览、答案解析、整卷仿真简版

任务要求：
核对/完善预览页：学生版、答案解析版、题目分区、题号、选项/填空/解答区、普通/整卷仿真视觉区别、重新生成、loading/empty/error。输出 task-07-report.md、project-state.md。

结束条件：
1. 写出 docs/auto-execute/task-07-report.md。
