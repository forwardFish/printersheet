...
当前任务编号：Task 03
当前任务标题：数据模型、状态管理、API 合同、Mock 生成器

任务要求：
核对/完善 Worksheet、Question、PaperBlueprint 数据结构、API client、mock 生成器、JSON 校验/normalize/repair、真实 AI 接口占位与前端密钥隔离。输出/更新 03-api-contract.md、task-03-report.md、project-state.md。

结束条件：
1. 写出 docs/auto-execute/task-03-report.md。
